...
const NavLg=()=>{
    return(
        <div className="container flex justify-around items-center mx-auto">
            ...
            <span className="text-gray-400 text-sm flex items-center hover:text-white cursor-pointer">Bhubaneswar <BiChevronDown/> </span>
...
const Navbar =()=>{
    return(
        <>
        <nav className="bg-navCol1-700 px-4 py-2" >
