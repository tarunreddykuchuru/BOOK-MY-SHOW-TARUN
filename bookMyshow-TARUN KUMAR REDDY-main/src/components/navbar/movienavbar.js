...
import {BiChevronRight,BiChevronDown,BiSearch, BiMenu,BiChevronLeft,BiShareAlt} from "react-icons/bi";
const NavSm=()=>{
    return(
        <>
...
const NavLg=()=>{
    return(
        <div className="container flex justify-around items-center mx-auto">
            <div className="flex items-center w-1/2 h-12 gap-5">
                <div>
                ...
                <div className="w-full flex items-center bg-white gap-3 px-3 py-1.5 rounded-md">
                    <BiSearch/>
            ...
            <span className="text-gray-400 text-sm flex items-center hover:text-white cursor-pointer">Hyderabad <BiChevronDown/> </span>
            <button className="bg-bhanu-300 text-white text-sm px-3 py-1 rounded-md">Sign In</button>
...
const MovieNavbar =()=>{
    return(
        <>
        <nav className="absolute inset-x-0 z-30 bg-opacity-10 backdrop-filter backdrop-blur-lg lg:relative lg:bg-opacity-100 bg-navCol1-700 px-4 py-2" >
